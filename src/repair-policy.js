...
export const REPAIR_POLICY = Object.freeze({
  ...
  'task.evidence.lineage.stale': policy('evidence', 'repair_live_carrier_lineage', 'none', 'The current task carrier differs from the live Engineer attempt lineage terminal.'),
  'task.carrier.armed': policy('evidence', 'repair_live_carrier_lineage', 'none', 'A live Engineer attempt freezes unrelated task-carrier mutations.'),
